  ...
  return (
    <AnimatedSection className="py-24 relative overflow-hidden">
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="font-heading text-4xl font-bold tracking-tight sm:text-5xl mb-6">Let's Build Something Secure</h2>
        <p className="text-xl text-muted-foreground mb-10 max-w-2xl mx-auto">
          Explore my hands-on engineering projects or read my latest security research.
        </p>
